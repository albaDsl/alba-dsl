...
expectedOpcode 0x65 = OP_VERIF_OP_BEGIN
expectedOpcode 0x66 = OP_VERNOTIF_OP_UNTIL
...
expectedOpcode 0x89 = OP_RESERVED1_OP_DEFINE
expectedOpcode 0x8A = OP_RESERVED2_OP_INVOKE
expectedOpcode 0x8B = OP_1ADD
expectedOpcode 0x8C = OP_1SUB
expectedOpcode 0x8D = OP_2MUL_OP_LSHIFTNUM
expectedOpcode 0x8E = OP_2DIV_OP_RSHIFTNUM
...
expectedOpcode 0x98 = OP_LSHIFT_OP_LSHIFTBIN
expectedOpcode 0x99 = OP_RSHIFT_OP_RSHIFTBIN
