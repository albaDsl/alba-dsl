...
expectedOpcode 0x65 = OP_BEGIN
expectedOpcode 0x66 = OP_UNTIL
...
expectedOpcode 0x89 = OP_DEFINE
expectedOpcode 0x8A = OP_INVOKE
expectedOpcode 0x8B = OP_1ADD
expectedOpcode 0x8C = OP_1SUB
expectedOpcode 0x8D = OP_LSHIFTNUM
expectedOpcode 0x8E = OP_RSHIFTNUM
...
expectedOpcode 0x98 = OP_LSHIFTBIN
expectedOpcode 0x99 = OP_RSHIFTBIN
