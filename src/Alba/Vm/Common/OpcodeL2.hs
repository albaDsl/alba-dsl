...
opcodeL2ToCodeL1 OP_BEGIN = Just $ toCodeL1 L1.OP_BEGIN
opcodeL2ToCodeL1 OP_UNTIL = Just $ toCodeL1 L1.OP_UNTIL
...
opcodeL2ToCodeL1 OP_DEFINE = Just $ toCodeL1 L1.OP_DEFINE
opcodeL2ToCodeL1 OP_INVOKE = Just $ toCodeL1 L1.OP_INVOKE
opcodeL2ToCodeL1 OP_1ADD = Just $ toCodeL1 L1.OP_1ADD
opcodeL2ToCodeL1 OP_1SUB = Just $ toCodeL1 L1.OP_1SUB
opcodeL2ToCodeL1 OP_LSHIFTNUM = Just $ toCodeL1 L1.OP_LSHIFTNUM
opcodeL2ToCodeL1 OP_RSHIFTNUM = Just $ toCodeL1 L1.OP_RSHIFTNUM
...
opcodeL2ToCodeL1 OP_LSHIFTBIN = Just $ toCodeL1 L1.OP_LSHIFTBIN
opcodeL2ToCodeL1 OP_RSHIFTBIN = Just $ toCodeL1 L1.OP_RSHIFTBIN
...
getOp' L1.OP_BEGIN code = Just (OP_BEGIN, code)
getOp' L1.OP_UNTIL code = Just (OP_UNTIL, code)
...
getOp' L1.OP_DEFINE code = Just (OP_DEFINE, code)
getOp' L1.OP_INVOKE code = Just (OP_INVOKE, code)
getOp' L1.OP_1ADD code = Just (OP_1ADD, code)
getOp' L1.OP_1SUB code = Just (OP_1SUB, code)
getOp' L1.OP_LSHIFTNUM code = Just (OP_LSHIFTNUM, code)
getOp' L1.OP_RSHIFTNUM code = Just (OP_RSHIFTNUM, code)
...
getOp' L1.OP_LSHIFTBIN code = Just (OP_LSHIFTBIN, code)
getOp' L1.OP_RSHIFTBIN code = Just (OP_RSHIFTBIN, code)
